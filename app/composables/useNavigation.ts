...
export const useNavigation = () => {
	...
	const links = computed<NavigationLink[]>(() => {
		...
		return [
			{ title: 'Панель правления', link: '/', icon: 'mdi-view-dashboard' },
			{ title: 'Оперативные новости', link: '/news', icon: 'mdi-newspaper' },
			{ spacer: true, class: 'splitter' },
			{ title: 'Данные абонента', link: '/profile', icon: 'mdi-account' },
			{ spacer: true, class: 'splitter' },
