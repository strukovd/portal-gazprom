			...
			<form class="form" @keyup.enter="signIn" @submit.prevent="signIn">
				<div class="logo">
					<svg height="70" viewBox="0 0 251 124" style="padding: 10px;" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<path d="M43.2 80.5V93.8C43.2 93.8 43.2 93.8 43.2 93.7C47.9 89 55.3999 89 60.0999 93.7C64.7999 98.4 64.7999 105.9 60.0999 110.6C60.0999 110.6 60.0999 110.6 60 110.7C60 110.7 60 110.7 59.9 110.8C55.2 115.4 49.0999 117.7 43.0999 117.7C37 117.7 30.9 115.4 26.2 110.7C18 102.5 17 89.8 23.2999 80.5C24.0999 79.2 25.1 78.1 26.2 76.9C30.9 72.2 37 69.9 43.0999 69.9V38C19.6999 38 0.699951 57 0.699951 80.5C0.699951 104 19.7999 123.1 43.2999 123.1C55.5999 123.1 66.6 117.9 74.4 109.6V80.5H43.2Z" fill="#0079C1"></path>
